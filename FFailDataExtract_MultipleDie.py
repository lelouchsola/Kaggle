...
FilePath = '/home/gechen/Project/BIBshading/perfect_touch/data/MultiDiePath/MultiDiePath.csv'
Parquet_MltiDie = pd.read_csv(FilePath, header=0)
parquet_file_list = Parquet_MltiDie['HDFS_PATH'].tolist()
parquet_file_list = list(set(parquet_file_list))
...
datafiles = ','.join(parquet_file_list) 
...
"""
split data, get FID, slotPosition, BIBLocation and Die No.

+---------------+-----------------+---------+---------+-----------+--------------------+-----------+------------+------------+-----------+-----+
|     SUMMARY_ID|              FID|     SITE|DESIGN_ID| MACHINE_ID|      DEF_FIRST_FAIL|SITE_STATUS|MFG_WORKWEEK|SlotPosition|BIBLocation|DieNo|
+---------------+-----------------+---------+---------+-----------+--------------------+-----------+------------+------------+-----------+-----+
|HRB/BD/K3/11UNU|370753L:12:N09:14|   P18K07|     Z11B|AX5612-0356|at88::ddmhfpblrcs...|       true|      201922|         P18|        K07|     |
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19L08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        L08|     |
|HRB/BD/K3/11UNU|370753L:12:N09:28|P19F12:D0|     Z11B|AX5612-0356|                    |       true|      201922|         P19|        F12|   D0|
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19K08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        K08|     |
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19N08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        N08|     |
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19M08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        M08|     |
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19H08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        H08|     |
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19G08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        G08|     |
|HRB/BD/K3/11UNU|0000000:00:P00:00|   P19J08|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P19|        J08|     |
"""

df_FFailInfo = df_FFailInfo.withColumn('FID',substring('FID',0,17))
df_FFailInfo = df_FFailInfo.withColumn("SlotPosition",substring("SITE", 1, 3))
df_FFailInfo = df_FFailInfo.withColumn("BIBLocation",substring("SITE", 4, 3))
df_FFailInfo = df_FFailInfo.withColumn("DieNo",substring("SITE", 8, 2))
#df_FFailInfo.show()
...
BIBDataCollection = df_FFailInfo.join(BIB_info.withColumnRenamed('summaryID','SUMMARY_ID'), ['SUMMARY_ID','SlotPosition'], 'inner')
...
"""
As talked with Regina, they want to calculate the fail rate at die level, not package level.
Drop row like this:
HRB/BD/K3/11UNU|370753L:12:N09:14|   P18K07|     Z11B|AX5612-0356|at88::ddmhfpblrcs...|       true|      201922|         P18|        K07|     |

It is the repetition of a die info on this socket. 
As talked with Regina, we decided to remain the die level information.

+---------------+-----------------+---------+---------+-----------+--------------------+-----------+------------+------------+-----------+-----+
|     SUMMARY_ID|              FID|     SITE|DESIGN_ID| MACHINE_ID|      DEF_FIRST_FAIL|SITE_STATUS|MFG_WORKWEEK|SlotPosition|BIBLocation|DieNo|
+---------------+-----------------+---------+---------+-----------+--------------------+-----------+------------+------------+-----------+-----+
|HRB/BD/K3/11UNU|370753L:12:N09:28|P19F12:D0|     Z11B|AX5612-0356|                    |       true|      201922|         P19|        F12|   D0|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18G05:D0|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D0|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18G05:D1|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D1|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18G05:D2|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D2|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18G05:D3|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D3|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18F05:D0|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        F05|   D0|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18F05:D1|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        F05|   D1|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18F05:D2|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        F05|   D2|
|HRB/BD/K3/11UNU|0000000:00:P00:00|P18H05:D1|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        H05|   D1|

"""
BIBDataCollection = BIBDataCollection.filter(col('DieNo') != '') #drop
#df_FFailInfo.show()
...
'''drop useless column and undate the first fail info'''
"""
+---------------+-----------------+---------+-----------+--------------------+-----------+------------+------------+-----------+-----+----------------+
|     SUMMARY_ID|              FID|DESIGN_ID| MACHINE_ID|      DEF_FIRST_FAIL|SITE_STATUS|MFG_WORKWEEK|SlotPosition|BIBLocation|DieNo|       FirstFail|
+---------------+-----------------+---------+-----------+--------------------+-----------+------------+------------+-----------+-----+----------------+
|HRB/BD/K3/11UNU|370753L:12:N09:28|     Z11B|AX5612-0356|                    |       true|      201922|         P19|        F12|   D0|                |
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D0|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D1|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D2|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        G05|   D3|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        F05|   D0|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        F05|   D1|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        F05|   D2|abp35::emptyTest|
|HRB/BD/K3/11UNU|0000000:00:P00:00|     Z11B|AX5612-0356|abp35::emptyTest#...|      false|      201922|         P18|        H05|   D1|abp35::emptyTest|
"""

BIBDataCollection = BIBDataCollection.drop("SITE") # drop "site"    
split_col = split("DEF_FIRST_FAIL", '#') 
BIBDataCollection = BIBDataCollection.withColumn("FirstFail", split_col.getItem(0)) # unpdate first fail info. Ex: abp35::emptyTest#@XXXX to abp35::emptyTest
#df_FFailInfo.show()
...
"""
aggregate the site status column and first fail column, now one BIB one row.
+---------------+---------+-----------+------------+------------+-----+--------------------+--------------------+
|     SUMMARY_ID|DESIGN_ID| MACHINE_ID|SlotPosition|MFG_WORKWEEK|DieNo|            siteinfo|          first_fail|
+---------------+---------+-----------+------------+------------+-----+--------------------+--------------------+
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P01|      201923|   D0|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P01|      201923|   D1|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P01|      201923|   D2|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P01|      201923|   D3|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P02|      201923|   D0|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P02|      201923|   D1|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
|377/98/2L/00LNU|     Z11B|AX5612-0294|         P02|      201923|   D2|[1, 1, 0, 0, 0, 1...|[, , abp35::empty...|
"""
df_FFailInfo = BIBDataCollection.withColumn("SITE_STATUS2", SiteStatusReplace("SITE_STATUS")) # change True or False into 1 or 0
#df_FFailInfo = df_FFailInfo.groupby("SUMMARY_ID","DESIGN_ID", "MACHINE_ID","SlotPosition", "MFG_WORKWEEK", "DieNo").agg(collect_list("SITE_STATUS2").alias("siteinfo"),collect_list("FirstFail").alias("first_fail"))
df_FFailInfo = df_FFailInfo.groupby("SUMMARY_ID","DESIGN_ID", "MACHINE_ID", "BIBID","BIBType", "JTSID", "SBTID", "MFG_WORKWEEK", 
                     "DieNo").agg(collect_list("SITE_STATUS2").alias("siteinfo"),
                                  collect_list("FirstFail").alias("first_fail")).orderBy(['SUMMARY_ID', 'BIBID','DieNo'])
#df_FFailInfo.show()
...
"""
change the summary id into (summary id + Die Number). For example, 377/98/2L/00LNU into 377/98/2L/00LNU_D0
"""
from pyspark.sql.functions import concat, lit
df_FFailInfo = df_FFailInfo.withColumn('SUMMARY_ID_NEW', concat(col("SUMMARY_ID"), lit("_"), col("DieNo"))) # create a new column call "SUMMARY_ID_NEW" to store the string (summary id + Die Number)
...
"""
df_FFailInfo = df_FFailInfo.select("SUMMARY_ID_NEW","DESIGN_ID", "BIBID","BIBType", "JTSID", "SBTID","MACHINE_ID", "MFG_WORKWEEK", GetBinToHex("siteinfo").alias('hex_site_status'), "first_fail")
#BIBDataCollection.show()
...
"""
change the "SUMMARY_ID_NEW" column name into "SUMMARY_ID" to stay the same with SDP data
"""
df_FFailInfo = df_FFailInfo.withColumnRenamed('SUMMARY_ID_NEW','SUMMARY_ID')
#BIBDataCollection.show()
...
df_FFailInfo = df_FFailInfo.withColumn('first_fail_string',array_to_string_udf("first_fail"))
df_FFail1 = df_FFailInfo.drop("first_fail")
...
df_FFail1.repartition(10).write.csv('FFailInfo_update_MultiDie',mode='overwrite',compression='gzip',header='true')  
...
(ret, out, err) = run_cmd(['hdfs','dfs','-copyToLocal','FFailInfo_update_MultiDie','/home/gechen/Project/BIBshading/perfect_touch/data/']) 
...
sparksession.stop()
print ('Multiple die data is extracted successfully')
sys.exit()
